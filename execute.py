...
def main():
    ...
    # rolling_7d_revenue_by_region: for each region, last value of 7-day moving avg of daily revenue
    ...
    rolling = (
        ...
        .apply(lambda g: g.set_index("date")["revenue"].rolling("7D").mean(), include_group_columns=False)
